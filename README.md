...
## Set Up (Modifying)
  ...
  3. Follow process | Process can be found in [the contributing file](https://github.com/casheridan/swat-website/blob/master/CONTRIBUTING.md) and [the wiki](https://github.com/casheridan/swat-website/wiki/Github-Contributing-Process)
